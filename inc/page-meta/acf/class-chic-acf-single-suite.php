...
class Chic_Acf_Single_Suite extends Chic_Acf_Base {
	...
	private function register(): void {
		$fields = array_merge(
			...
			[
				[
					'key'           => 'field_chic_suite_features',
					'name'          => 'chic_suite_features',
					'label'         => 'Suite Features',
					'instructions'  => 'Select every feature this suite has. Each checked item appears as an icon in the amenities strip.',
					'type'          => 'checkbox',
					'choices'       => [
						'sofa'     => 'Sofa',
						'sofa_bed' => 'Sofa / Bed',
