...
<main class="page-404">
	...
	<section class="home-hero home-hero--static home-hero--404" aria-label="404 error">
		...
		<div class="home-hero__overlay">
			<div class="home-hero__inner">
				<div class="home-hero__content home-hero__content--centered fade-in">
					<p class="hero-404__label">404 Error</p>
					<h1 class="home-hero__title hero-404__heading">Page Not Found</h1>
					<p class="home-hero__text">The page you're looking for doesn't exist or may have been moved.</p>
